...
def write_js(
    ...
    # countries.js
    with open('../views/src/js/data/countries.js', 'w') as f:
    ...
    args:
        ...
        - js_file_name (str) : views/src/js/data/{here}.js
    ...
    with open(f'models/data/{json_folder_name}/{json_file_name}.json', 'w') as f:
        json.dump(dic, f)
    # write js file to views/src/js/data
    with open(f'../views/src/js/data/{js_file_name}.js', 'w') as f:
...
def make_all():
    """Make all json files.
    """
    # country_codes/country_codes.json -> js/data/countries.js
    write_js(
