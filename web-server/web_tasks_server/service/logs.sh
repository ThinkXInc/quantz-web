...
tmux new-session -d -s logsWebTasks -n '' \
'bash -c "printf \"\033]2;Billing Scheduler\033\\\\\"; exec journalctl -fu billing_scheduler.service --output cat"'
...
tmux attach-session -t logsWebTasks
