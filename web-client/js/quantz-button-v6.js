(function(ns) {
    ...
    ns.setupInteractions = function(btn, controller) {
            ...
            switch (controller.buttonState) {
                case ns.ButtonState.standby:
                    ...
                    core.connect(() => {
                        ...
                        if (ns.Config.buttonType == ns.ButtonType.A) {
                            ns.indicatorController.connectedAnimation();
                        }
                ...
                case ns.ButtonState.pushSpeak:
                    ...
                    if (ns.Config.buttonType == ns.ButtonType.A) {
                        ...
                        ns.indicatorController.listeningAnimation();
                    }
        ...
        const onMouseUp = () => {
            ...
            switch (controller.buttonState) {
                ...
                case ns.ButtonState.listening:
                    ...
                    core.stopRecording();
                    if (ns.Config.buttonType == ns.ButtonType.A) {
                        ns.indicatorController.replyStartAnimation()
        ...
        document.addEventListener(ns.Config.responseStartEventName, function(event) {
        ...
        document.addEventListener(ns.Config.audioSignalEventName, function(event) {
            const spectrum = event.detail;
            console.log('spectrum size:', spectrum.length, 'received')
            //console.log('**** spectrum', spectrum);
            ns.indicatorController.speakingAnimation(spectrum);
        })

        document.addEventListener(ns.Config.endAudioSignalEventName, function(event) {
            console.log('**** (finish) spectrum');
            ns.indicatorController.resetToConnectedAnimation();
        })
        ...
        document.addEventListener(ns.Config.endTurnEventName, function(event) {
            ...
            ns.indicatorController.endTurnAnimation();
        });
        ...
        document.addEventListener(ns.Config.failedToGetTokenEventName, function(event) {
            ...
            if (status == 429 || status == "429") {
                controller.switchToLimitReached();
            } else {
